    ...
    <div className="flex min-h-screen bg-black font-sans">
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-[200] lg:hidden">
          <div className="absolute inset-0 bg-black/90 backdrop-blur-sm" onClick={closeMenu} />
          <div className="absolute inset-y-0 left-0 w-72 bg-[#0a0a0a] border-r border-gray-900 shadow-2xl flex flex-col">
            <div className="p-5 flex justify-between items-center border-b border-gray-900">
              ...
              <button onClick={closeMenu} className="text-white p-2 bg-gray-900 rounded-xl">
                <X size={20} />
              </button>
            </div>
        ...
        <header className="h-16 border-b border-gray-900 flex items-center justify-between px-6 sticky top-0 bg-black/80 backdrop-blur-xl z-[100]">
          <div className="flex items-center gap-4">
            <button
              ...
              className="lg:hidden p-2 text-white bg-gray-900 rounded-lg"
            >
              <Menu size={20} />
            </button>
