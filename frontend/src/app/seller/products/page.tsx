      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-4">
          {products.map((product: any) => (
            <div key={product._id} className="bg-[#0A0A0A] border border-gray-900 p-4 sm:p-6 rounded-[2rem] flex flex-col sm:flex-row items-center justify-between gap-6 hover:border-blue-500/30 transition-all group shadow-xl">
