...
function AdminProductsContent() {
  ...
  const fetchProducts = async (pNum = pageNumber) => {
    try {
      const res = await fetch(`${BASE_URL}/api/products/all?pageNumber=${pNum}`);
  ...
  return (
    <div className="flex min-h-screen bg-black text-white">
      ...
      <main className="flex-1 p-8">
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm p-4 z-50">
            <Link href="/admin/products" className="flex items-center gap-2 text-gray-500 hover:text-white transition mb-8">
            ...
            <div className="bg-gray-900 border border-gray-800 p-8 rounded-2xl w-full max-w-md shadow-2xl overflow-y-auto max-h-[90vh]">
              ...
              <form onSubmit={submitHandler} className="h-full w-full space-y-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  />
                  {uploading && <p className="text-blue-400 text-xs animate-pulse">Uploading...</p>}
                </div>
                <textarea
                ...
                <div className="flex gap-4 mt-6">
                  ...
                  <button type="button" onClick={closeModalHandler} className="flex-1 bg-gray-800 py-3 rounded-lg font-bold text-gray-400">
                    Cancel
                  </button>
                </div>
              </form>
...
export default function AdminProductsPage() {
  return (
    <AdminRoute>
      <Suspense fallback={<div className="min-h-screen bg-black text-white p-8">Loading Products UI...</div>}>
