export const HOME_CARDS = [
  {
    ...
    items: [
      { name: "Air conditioners", image: "/ac.jpg", link: "/search?category=Air Conditioners" },
      { name: "Refrigerators", image: "/fridge.jpg", link: "/search?category=Refrigerators" },
      { name: "Microwaves", image: "/micro.jpg", link: "/search?category=Microwaves" },
      { name: "Washing machines", image: "/wm.jpg", link: "/search?category=Washing Machines" },
    ],
  ...
  },
  {
    ...
    items: [
      { name: "Laptops", image: "/laptop.jpg", link: "/search?category=Laptops" },
      { name: "Mice", image: "/mouse.jpg", link: "/search?category=Mice" },
